...
total_sqft= st.number_input('Total Square Feet',min_value=450,max_value=30000)
st.info("For better predictions, enter Total Square Feet value within the range of 450 to 30000.")
